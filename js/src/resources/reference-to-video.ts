...
import type { CompletedVideoTaskResponse, ReferenceToVideoParams, VideoTaskResponse } from '../types';

const ENDPOINT = '/api/v1/wan/reference_to_video';

export class ReferenceToVideo {
  constructor(private readonly http: HttpClient) {}

  async run(params: ReferenceToVideoParams, options?: RequestOptions & PollingOptions): Promise<CompletedVideoTaskResponse> {
  ...
  async create(params: ReferenceToVideoParams, options?: RequestOptions): Promise<{ id: string }> {
